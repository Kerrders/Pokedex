export const pokemonSpecies = [
  ...
  {
    id: 902,
    identifier: 'basculegion',
    generation_id: 8,
    evolves_from_species_id: 550,
    evolution_chain_id: '',
    color_id: 5,
    shape_id: 3,
    habitat_id: '',
