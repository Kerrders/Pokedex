...
export class OverviewDataSourceService extends MatTableDataSource<PokemonList> {
  ...
  public loadPage(page: number, pageSize = 20): void {
    this._httpClient.get<PokemonPaginatedList>(`https://pokeapi.co/api/v2/pokemon/?limit=${pageSize}&offset=${page > 1 ? pageSize * page : 0}`).subscribe((result: PokemonPaginatedList) => {
